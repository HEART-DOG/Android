...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, final ViewGroup parent)
    {
        ...
        TextView oTextDate = (TextView) convertView.findViewById(R.id.tv_dsn);
        TextView oTextNumber = convertView.findViewById(R.id.tv_number);

        oTextTitle.setText(m_oData.get(position).getDogName());
        oTextDate.setText(m_oData.get(position).getDsn());
        oTextNumber.setText(Integer.toString(m_oData.get(position).getCount()));
